...
int Timer(char **argv,unsigned short argc)
{
//set up timer A0 
TA2CTL|=TASSEL_1|ID_3|MC__UP|TACLR|TAIE;
TA2CCTL0|=CCIE;
TA2CCTL1|=CCIE;
TA2CCR0=107000; 
TA2CCR1=106000; 
...
void TimerA2_ccr0_Interrupt(void) __interrupt[TIMER2_A0_VECTOR]{
P7OUT=0x00 ;
P7DIR=0xFF;
}

void TimerA2_ccr1_3_Interrupt(void) __interrupt[TIMER2_A1_VECTOR]{
    switch (TA2IV){
...
const CMD_SPEC cmd_tbl[]={{"help"," [command]",helpCmd},
                   ...
                   {"timer", "Blinks LED based on timer",Timer},
